...
from .exeptions import NotASelectElementException, NoSuchElementException, NotAValidSelectOption
    ...
    def choose(self, txt):
        try:
            ...
            raise NotAValidSelectOption(
                'Option {txt} is not present in existing options:, {self.options}'
            ) from e
